...
read admin_password
go-passbolt-cli configure --serverAddress https://passbolt.cocopaps.com --userPassword "${admin_password}" --userPrivateKeyFile ~/.passbolt_private_admin.acs
...
go-passbolt-cli configure --serverAddress https://passbolt.cocopaps.com --userPassword "${ci_user_password}" --userPrivateKeyFile ~/.passbolt_private_ci_user.acs

...
export TF_VAR_mosquitto_user="$(fetch_secret mosquitto_user)"
export TF_VAR_mosquitto_password="$(fetch_secret mosquitto_password)"
...
export TF_VAR_discord_webhook_raspi="$(fetch_secret discord_webhook_raspi)"
